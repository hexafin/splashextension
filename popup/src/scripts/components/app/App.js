...
import splashSmile from "../../../assets/images/smile-splash.png"
		...
		return (
			<div className="wrapper">
				<div className="logo-header">
					<img className="logo" src={splashSmile} />
					<div className="logo-slogan">
						We splashed <strong>openai.com</strong> for you
					</div>
				</div>
				<div className="container">
					<div className="fonts">
						...
						{mockFonts.map(font => (
							<Font key={font.displayFontName} {...font} />
						))}
					</div>
					<div>
